...
function Sidebar() {
    const SidebarData = [
        ...
        {
            icon: <svg viewBox="0 0 24 24" aria-hidden="true" className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-18jsvk2 r-lwhw9o r-cnnz9e"><g><path d="M7.323 2h11.443l-3 5h6.648L6.586 22.83 7.847 14H2.523l4.8-12zm1.354 2l-3.2 8h4.676l-.739 5.17L17.586 9h-5.352l3-5H8.677z"></path></g></svg>
            , title: "verified Orgs",
            path: "/verified-orgs"
    ...
    return (
        ...
        <Container className="w-1/4 min-h-screen px-1 flex flex-col items-center border-r border-r-gray-300 justify-evenly">
            ...
            <ul className="flex flex-col gap-2 ">
                {SidebarData.map((item, index) => (
                    <Link to={item.path} key={index} className="flex items-center w-fit gap-3 py-2 px-2 sm:px-5 rounded hover:bg-gray-200 hover:rounded-full cursor-pointer">
            ...
            <button
                className="bg-[#080c0f] my-1 hover:bg-[#080c0f]/95 text-white w-fit font-semibold text-xl py-2 px-2 sm:px-10 flex items-center justify-center transition duration-200 ease-in-out  rounded-full sm:rounded-4xl"
            >
            ...
            <div className="flex items-center justify-between gap-12 my-1 px-3 py-2 w-fit hover:bg-gray-200 hover:rounded-full ">
                {/* Profile Image */}
                <div className="flex items-center gap-2">
                    <img className="w-10 h-10 rounded-full object-cover" src="/1.jpeg" alt="profile image" />

                    {/* User Info */}
                    <div className='hidden sm:block'>
                        <h5 className="text-sm font-semibold leading-tight">FullName</h5>
                        <h6 className="text-xs text-gray-500">@UserName</h6>
                    </div>
                </div>

                {/* Three-Dot Icon */}
                <div className=" hidden sm:block text-gray-600 hover:text-black cursor-pointer">
