  ...
  return (
    <>
      <Container className="w-[60%]">
        <div
          className="text-white w-full bg-gray-800 border-2 border-gray-600 px-1 py-2 rounded-xl"
          onDrop={handleDrop}
        ...
        >
          <div className="flex gap-4 py-4 justify-center">
            ...
            <div className="w-[80%] h-auto min-h-28 max-h-64 overflow-y-scroll scrollbar-thumb-only pr-4">
              <textarea
                ...
                className="placeholder:font-normal  text-xl resize-none w-full border-none focus:outline-none overflow-hidden"
          ...
          <div className="flex justify-between mx-2 px-4  items-center border-t-1 border-gray-500 pt-2">
            <div className="flex gap-3">
              ...
              >
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  className="w-6 fill-sky-500 r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-z80fyv r-19wmn03"
                >
                  <g>
              ...
              <Button  onBtnClick={handleDefalut}>
                <svg
                  viewBox="0 0 33 32"
                  aria-hidden="true"
                  className="fill-sky-500 w-6 r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-z80fyv r-19wmn03"
                >
                  <g>
            ...
            <Button
              classname="bg-white p-1 px-4 text-lg text-black font-medium cursor-pointer  disabled:opacity-70 disabled:cursor-not-allowed"
